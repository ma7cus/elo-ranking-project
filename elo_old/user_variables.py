#File variables
DIRECTORY = r"C:\Users\marcu\OneDrive\.EDUCATION MARCUS\Elo modular 2"
INITIAL_CSV_FILE = 'top_100_clean.csv'#Initial file with items to be sorted

#Specify any colummns 
KEEP_COLUMNS = ['Year','Rating']  # Add the column names of any additional columns you want to keep here, or leave it empty for none
...
STANDARD_ELO = 1000  # Standard starting Elo score for films with no initial rating
