...
from user_variables import INITIAL_CSV_FILE, DIRECTORY
...
def main():
    ...
    # Step 4: Run film comparisons (using StateManager to manage state)
    ...
    # Step 7: Plot the Elo rankings of films
