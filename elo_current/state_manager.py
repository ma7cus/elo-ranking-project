...
class StateManager:
    ...
    def __init__(self):
        ...
        - `comparison_count` (int): Keeps track of the number of item comparisons made.
          Initialized to 0.
    ...
    def set_expected_score_matrix(self, num_items):
        ...
        :param num_items: Number of items to initialize the matrix.
        """
    ...
    def increment_comparison_count(self):
        ...
        This method is called whenever a new comparison between two items is made. 
    ...
    def stop(self):
        ...
        When `stop_flag` is True, the comparison loop will break, ending the item comparison process.
        """
        self.stop_flag = True
